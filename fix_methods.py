...
# It looks like the methods for createCinematicCurve, createFujiCurve, createVividCurve, and createSafeRec709Curve
# were accidentally deleted or placed outside the class in one of the previous git rebase/script cleans.
...
if 'createCinematicCurve' not in content:
    content = content.replace('    private TonemapCurve createLogTonemapCurve() {', methods_to_add + '\n    private TonemapCurve createLogTonemapCurve() {')
