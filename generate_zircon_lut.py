...
def zircon_inverse(y):
    # The math inverse of y = log10(10x + 1) / log10(11)
    # x = (11^y - 1) / 10
    val = (math.pow(11.0, y) - 1.0) / 10.0
    return max(0.0, min(1.0, val))

NEW_SIZE = 33
with open('ZIRCON_LOG_TO_REC709.cube', 'w') as f:
    f.write('TITLE "Zircon Log to Rec.709 Linearization"\n')
...
print("ZIRCON_LOG_TO_REC709.cube generated!")
