  ...
  Widget _isoRuler(bool enabled) {
    return _RulerWithHint(
      ...
      child: CinemaRuler(
        ...
        enabled: enabled,
        snapPoints: const <double>[0, 1, 2, 3, 4, 5, 6],
        presets: const <CinemaRulerPreset>[
          ...
          CinemaRulerPreset(4, '800 A-MAX'),
          CinemaRulerPreset(5, '1600 DIGITAL'),
          CinemaRulerPreset(6, '3200 DIGITAL'),
        ],
...
String _helper(CameraControl control) => switch (control) {
  ...
  CameraControl.iso => '50–800 analog • 1600/3200 digital',
